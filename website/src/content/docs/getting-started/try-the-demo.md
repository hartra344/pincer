...
- **No gateway administration.** Apart from Approval History, Gateway Settings, automations and plugins aren't simulated. For those, use the [mock gateway](../../development/mock-gateway/).
